...
You can now view tokyo-white-react-admin-dashboard-js in the browser.
  ...
  On Your Network:  http://192.168.1.215:3006
...
To create a production build, use npm run build.`;
  ...
  return (
    <>
      <Helmet>
        <title>Installation - Tokyo White React Javascript Admin Dashboard</title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            ...
            <Typography paragraph>
              ...
              http://localhost:3006 and the terminal will show a message similar
              to the one below:
            </Typography>
            <Prism wrapLines language="javascript" style={a11yDark}>
              {devBuild}
